...
tons of liter in total. Also `Mr. Trash Wheel`collected a total of 
...
`month` in any given `year` in the period 1948-2015. Combined all 3 into one `all_data`
final datasets that has `r nrow(all_data)` observations and `r ncol(all_data)` variables
